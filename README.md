...
[**gpuwatch**](https://github.com/hitechcloud-vietnam/gpuwatch).
...
## Installation (cmake)
```
git clone https://github.com/hitechcloud-vietnam/gddr6
cd gddr6
./build_install.sh
sudo gddr6
```
...
![](https://github.com/hitechcloud-vietnam/gddr6/blob/main/gddr6_use.gif)
